...
ggplot(province_cases, aes(x=province, y=number_of_cases , fill=province)) + geom_bar(stat='identity') + coord_flip() + theme(axis.text.x = element_text(angle = 90, vjust = 1.0, hjust=1))+
labs(x='Province', y='Total number of confirmed cases') + ggtitle("Number of COVID cases in various provinces") 
```
```{r}
...
labs(x='Date', y='Number of confirmed cases') + ggtitle("Growth in number of COVID cases for various provinces") 
```
...
labs(x="Date", y="Number of total confirmed cases")+ ggtitle("Plot of total number of cases for Seoul province")
```
...
theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
labs(x="Date", y="Number of new confirmed cases") + ggtitle("Plot of new cases for Seoul province")
```
...
theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
labs(x="Date", y="Number of new deaths") + ggtitle("Plot of daily new deaths for Seoul province")
```
...
theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
labs(x="temp", y="Number of new cases") + ggtitle("Plot of new cases vs temperature for Seoul province")
```
...
theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
labs(x="Temperature", y="Average number of new cases") + ggtitle("Plot of average number of new cases vs temperature for Seoul province")
```
...
theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
labs(x="Precipitation", y="Number of new cases") + ggtitle("Plot of new cases vs precipitation for Seoul province")
```
...
theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
labs(x="Precipitation", y="Average number of new cases") + ggtitle("Plot of average number of new cases vs precipitation for Seoul province")
```
